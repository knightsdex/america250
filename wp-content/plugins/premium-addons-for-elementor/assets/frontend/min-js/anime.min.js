((n, e) => {
  ...
  function i(r, t) {
    ...
    function f(n) {
      var e = t ? (t * n) / 1e3 : n,
        e =
          u < 1
            ? Math.exp(-e * u * i) * (+Math.cos(s * e) + c * Math.sin(s * e))
            : (1 + c * e) * Math.exp(-e * i);
  ...
  function I(n, e) {
    for (
      ...
      i in n && ((t = n[i]), e.call(a, t, i, n)) && o.push(t);
    return o;
  }
  function f(n) {
      ...
      case "transform":
        return (
          ...
          (s = c((o = e), "scale")
            ? 1
            : 0 +
              (c((s = o), "translate") || "perspective" === s
                ? "px"
                : c(s, "rotate") || c(s, "skew")
                ? "deg"
                : void 0)),
          (s = $(a).get(o) || s),
          i && (i.transforms.list.set(o, s), (i.transforms.last = o)),
          u ? y(a, s, u) : s
        );
      case "css":
        return V(n, e, t);
        ...
        w.rgb(u)
          ...
          ? ((o =
            ...
            0 == u
              ? (t = r = a = s)
              : ((t = c(
                  (u = 2 * s - (s = s < 0.5 ? s * (1 + u) : s + u - s * u)),
                  s,
                  i + 1 / 3
                )),
                (r = c(u, s, i)),
                (a = c(u, s, i - 1 / 3))),
            "rgba(" + 255 * t + "," + 255 * r + "," + 255 * a + "," + o + ")")
          : void 0)
      : /\s/g.test(n)
      ? n
      : ((s = (u = B(n)) ? n.substr(0, n.length - u.length) : n),
        e ? s + e : s);
    function c(n, e, t) {
      return (
        t < 0 && (t += 1),
  ...
  function Y(n) {
    ...
    switch (n.tagName.toLowerCase()) {
      ...
      case "polygon":
        return (
          (e = n.points), X(n) + F(e.getItem(e.numberOfItems - 1), e.getItem(0))
        );
    }
    var e;
  }
  ...
  function Q(n) {
    ...
    return t.map(function (n, e) {
      return { target: n, id: e, total: t.length, transforms: { list: $(n) } };
    });
  }
  function z(n, e) {
    var t,
        ...
        r.push({
          ...
          tweens: ((n, t) => {
            var e,
              r = g(t),
              a =
                (/^spring/.test(r.easing) && (r.duration = i(r.easing)),
                w.arr(n) &&
  ...
  function _(u, s) {
    var c;
    return u.tweens.map(function (n) {
      var n = ((n, e) => {
          var t,
            r = {};
          for (t in n) {
      ...
      return (
        ...
        (n.isPath = w.pth(e)),
        (n.isPathTargetInsideSVG = n.isPath && w.svg(s.target)),
  ...
  function tn(n) {
    ...
    N = 0 < t ? requestAnimationFrame(tn) : void 0;
  }
  function n() {
  ...
  function L(n) {
    ...
    (e = x(u, (n = n = void 0 === n ? {} : n))),
      (t = z((r = x(M, n)), n)),
      (r = U((t = K((n = Q(n.targets)), t)), r)),
      (a = nn),
      nn++;
    var e,
      t,
    ...
    function y(e) {
      for (var n = 0, t = k.animations, r = t.length; n < r; ) {
        ...
        for (
          var u = C(e - s.start - s.delay, 0, s.duration) / s.duration,
            c = isNaN(u) ? 1 : s.easing(u),
            f = s.to.strings,
            l = s.round,
            d = [],
          ...
          var m = void 0,
            ...
            m = s.isPath
              ? ((e, t, n) => {
                ...
                })(s.value, c * v, s.isPathTargetInsideSVG)
              : y + c * (v - y);
        ...
        R[a.type](o.target, a.property, h, o.transforms),
          (a.currentValue = h),
          n++;
      }
    }
    ...
    function i(n) {
      ...
      if (
        ...
        var o = a;
        if (k.reversePlayback) for (var i = d; i--; ) v(o, s[i]);
        else for (var u = 0; u < d; u++) v(o, s[u]);
      }
    ...
    return (
      ...
      (k.play = function () {
        k.paused &&
          (k.completed && k.reset(), (k.paused = !1), S.push(k), o(), en());
      }),
      (k.reverse = function () {
  ...
  function an(n, e) {
    ...
    for (var a = r.length; a--; ) {
      var o = r[a],
        i = o.animations;
      rn(n, i), i.length || o.children.length || r.splice(a, 1);
    }
  ...
  return (
    ...
    (L.running = S),
    (L.remove = function (n) {
      for (var e = A(n), t = S.length; t--; ) an(e, S[t]);
    }),
    (L.get = T),
    (L.set = J),
    (L.convertPx = y),
    (L.path = function (n, e) {
      var t = w.str(n) ? a(n)[0] : n,
        r = e || 100;
      return function (n) {
        return { property: n, el: t, svg: Z(t), totalLength: Y(t) * (r / 100) };
      };
    }),
    ...
    (L.stagger = function (n, e) {
      ...
      return function (n, e, t) {
        if (
          ...
          for (var r, a, o, i = 0; i < t; i++)
            c
              ? ((r = p ? (c[0] - 1) / 2 : l % c[0]),
                (a = p ? (c[1] - 1) / 2 : Math.floor(l / c[0])),
                (r = r - (i % c[0])),
                (a = a - Math.floor(i / c[0])),
                (o = Math.sqrt(r * r + a * a)),
                "x" === f && (o = -r),
                M.push((o = "y" === f ? -a : o)))
              : M.push(Math.abs(l - i)),
